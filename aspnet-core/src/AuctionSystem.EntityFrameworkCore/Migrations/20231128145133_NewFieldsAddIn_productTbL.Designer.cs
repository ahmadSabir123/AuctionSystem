...
namespace AuctionSystem.Migrations
{
    ...
    [Migration("20231128145133_NewFieldsAddIn_productTbL")]
    partial class NewFieldsAddIn_productTbL
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AuctionSystem.Auction.Auction", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("AuctionSystem.Category.Category", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("AuctionSystem.Location.Location", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("AuctionSystem.Product.Product", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("AuctionSystem.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("AuctionSystem.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("AuctionSystem.Auction.Auction", b =>
                {
                    b.HasOne("AuctionSystem.Product.Product", "ProductFk")
                        .WithMany()
                        .HasForeignKey("ProductId");

                    b.HasOne("AuctionSystem.Authorization.Users.User", "UserFk")
                        .WithMany()
                        .HasForeignKey("UserId");
            ...
            modelBuilder.Entity("AuctionSystem.Product.Product", b =>
                {
                    b.HasOne("AuctionSystem.Category.Category", "CategoryFk")
                        .WithMany()
                    ...
                    b.HasOne("AuctionSystem.Authorization.Users.User", "NewOwnerFk")
                        .WithMany()
                        .HasForeignKey("NewOwnerId");

                    b.HasOne("AuctionSystem.Authorization.Users.User", "OwnerFk")
                        .WithMany()
