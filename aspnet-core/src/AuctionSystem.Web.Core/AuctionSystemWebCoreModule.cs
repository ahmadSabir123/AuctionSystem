...
namespace AuctionSystem
{
    ...
    public class AuctionSystemWebCoreModule : AbpModule
    {
        ...
        public AuctionSystemWebCoreModule(IWebHostEnvironment env)
        {
            _env = env;
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(AuctionSystemWebCoreModule).GetAssembly());
        }

        public override void PostInitialize()
        {
            IocManager.Resolve<ApplicationPartManager>()
                .AddApplicationPartsIfNotAddedBefore(typeof(AuctionSystemWebCoreModule).Assembly);
        }
    }
}
