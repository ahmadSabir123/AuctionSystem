...
using AuctionSystem.Models.TokenAuth;
...
{
    public abstract class AuctionSystemWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static AuctionSystemWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(AuctionSystemWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<AuctionSystemDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<AuctionSystemDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<AuctionSystemDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<AuctionSystemDbContext, Task<T>> func)
        {
            T result;
